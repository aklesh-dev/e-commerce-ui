    ...
    <div className="shadow-lg rounded-lg overflow-hidden">
      ...
      <div className="flex flex-col gap-4 p-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <button className="ring-1 ring-gray-300 px-2 py-1 shadow-lg rounded-md hover:text-white hover:bg-black transition-colors duration-300 cursor-pointer flex gap-2 items-center">
